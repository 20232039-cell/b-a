...
_HARD = re.compile(r"(핏\b|오버핏|루즈핏|슬림핏|레귤러핏|크롭|와이드|테이퍼|스트레이트|기장|총장|"
                   ...
                   r"셋업|레이어드|배색|컬러웨이|"
                   # 2026-09-20 — 매장이 그림에 적어 둔 불릿을 놓치고 있었다. drawfit 의
                   # 「두가지 원사를 믹스한 보카시 효과로 입체적이고 은은한 텍스처감」·
                   # 「탄탄한 2*2 RIB 작업으로 잦은 착용에도 늘어남 없이 형태 유지」가
                   # 둘 다 옷 이야기인데 어휘에 없어 버려졌다. 원단의 성질을 말하는 말이다.
                   r"텍스처|텍스쳐|질감|편직|원사|번수|게이지|보카시|형태\s?유지|늘어남|늘어짐|"
                   r"변형|무게감|중량감|광택|드레이프|탄탄|부드러|까슬|포근|따뜻|시원|"
